  ...
  <div className="fixed inset-0 w-full h-full overflow-hidden bg-gradient-to-b from-[#0f1729] via-[#1a2744] to-[#2c3a61]">
    ...
    <div className="stars-container relative w-full h-full">
      ...
      {[...Array(6)].map((_, i) => (
        <div
          key={`shooting-star-${i}`}
          className="absolute w-1 h-1 bg-white rounded-full before:content-[''] before:absolute before:w-32 before:h-[1px] before:bg-gradient-to-r before:from-[#ffffff80] before:to-transparent before:-left-32 animate-shooting-star"
          style={{
            top: `${Math.random() * 50}%`,
            left: '100%',
